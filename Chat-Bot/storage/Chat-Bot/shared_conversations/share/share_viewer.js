document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Function to copy text to clipboard (kept here for appendMessage dependency, but also in share.js)
    ...
    try {
        ...
        if (!shareHtmlResponse.ok) {
            throw new Error(`Failed to load share.html: ${shareHtmlResponse.statusText}`);
        }
        ...
        shareJsScript.onerror = (e) => {
            console.error('Error loading share.js:', e);
            const errorMessage = document.createElement('div');
            errorMessage.textContent = 'Error loading share functionality script. Please refresh.';
        ...
        const errorMessage = document.createElement('div');
        errorMessage.textContent = `Error loading share feature: ${error.message}. Please refresh.`;
        errorMessage.style.color = 'red';
        shareFeatureContainer.appendChild(errorMessage);
    }
